...
public class WordToPDF {
    ...
    public static void main(String[] args) {
        ...
        int time = convert2PDF("D:/20171221（浙江省中医院下沙院区 发给公司）(1).xls", "D:/20171221（浙江省中医院下沙院区 发给公司）(1).pdf");
    ...
    private static int convert2PDF(String inputFile, String pdfFile) {
        ...
        if (kind.equals("test/doc")||kind.equals("docx")||kind.equals("txt")) {
            return WordToPDF.WordToPDF(inputFile, pdfFile);
        }else if (kind.equals("ppt")||kind.equals("pptx")) {
            return WordToPDF.ppt2PDF(inputFile, pdfFile);
        }else if(kind.equals("xls")||kind.equals("xlsx")){
            return WordToPDF.Ex2PDF(inputFile, pdfFile);
        }else {
            return -4;
        }
    }
    ...
    private static int WordToPDF(String inputFile, String pdfFile) {
